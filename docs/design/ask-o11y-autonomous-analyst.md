...
> 2026-09-10 最新產品與瘦身方向見 [非專業使用者報告與系統瘦身](ask-o11y-novice-report-simplification.md)：靠 LLM 讓不懂分析／ML 的人得到看得懂、可追溯的報告，不能以減少 patch 或裸計算結果代替產品目標。
>
> 本文件保留第一批指引變更的驗證快照。後續能力重選與授權實作、最新限制和統一部署前檢查，見 [有界自主分析](ask-o11y-bounded-autonomy.md)。
> 2026-09-10 的階段核准修正設計見 [版本化提案與本輪回答綁定](ask-o11y-turn-decisions.md)：自然語言回答必須綁回待答提案，不能將歷史最終目標當成本輪交付要求。
