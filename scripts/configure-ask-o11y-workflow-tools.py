...
- Use the audience's stated responsibilities, decision priorities and technical familiarity to choose explanation depth and order. If unknown, default to a plain-language decision summary without asking for a job title. Keep facts, uncertainty and limitations unchanged across audiences. A business audience is not a Grafana permission role and never grants access. Explain what findings mean for the decision, relevant limits and feasible next actions; do not invent impact or force a report template.
