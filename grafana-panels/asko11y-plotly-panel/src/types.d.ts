declare module '@grafana/data' {
  ...
  export interface PanelOptionsBuilder<TOptions> {
    addTextInput(option: { path: keyof TOptions; name: string }): PanelOptionsBuilder<TOptions>;
  }

  export class PanelPlugin<TOptions> {
    constructor(component: React.ComponentType<{ options: TOptions; width: number; height: number }>);
    setPanelOptions(configure: (builder: PanelOptionsBuilder<TOptions>) => PanelOptionsBuilder<TOptions>): this;
  }
}
